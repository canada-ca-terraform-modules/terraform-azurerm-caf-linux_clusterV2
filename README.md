...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_linux_VMs"></a> [linux\_VMs](#module\_linux\_VMs) | github.com/canada-ca-terraform-modules/terraform-azurerm-caf-linux_virtual_machineV2.git | v1.0.0 |
