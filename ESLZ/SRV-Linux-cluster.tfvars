  ...
  devops = {
    ...
    linux_VMs = {
      test = {
        ...
        # custom_data                                            = "install-ca-certs"                                  # Optional: Use "install-ca-certs" shortcut or provide a relative path to a script file
        ...
        # Optional: Uncomment to configure boot diagnostic object settings.
        # boot_diagnostic = {
        #   use_managed_storage_account = true
        #   # storage_account_resource_id = "" # Only valid if use_managed_storage_account = false
        # }

        # Optional: Uncomment this block to set a key vault where the generated password will be stored.
        # key_vault = {
        #   name                = ""
        ...
        # Optional: Gallery application settings.
        # gallery_application = {
        #   version_id                                  = ""
        ...
        # Optional: Secret and certificate settings.
        # secret = {
        #   certificate = {
        #     store = ""
        #     url   = ""
        ...
        # Optional: OS image notification settings.
        # os_image_notification = {
        #   timeout = "PT15M"
        # }

        # Optional: Spot VM termination notification settings.
        # termination_notification = {
        #   enabled = false
        #   timeout = "PT5M"
        # }

        # Optional: Load balancer backend pool IDs.
        # load_balancer_address_pools_ids = {
        #   "ID" = {}
        # }

        # Optional: Application Security Group assignment.
        # asg = {
        #   application_security_group_id = ""
        # }

        # Optional: NIC NSG security rules. Requires use_nic_nsg = true.
        # security_rules = {
        #   test = {
        #     name                         = "Example"
        #     priority                     = 401
